...
--               e:/FPGA/SRM_FPGA/srm_open_loop_control_new/srm_open_loop_control_new.srcs/sources_1/ip/xadc_wiz_0/xadc_wiz_0_sim_netlist.vhdl
-- Design      : xadc_wiz_0
...
inst: unisim.vcomponents.XADC
    generic map(
      ...
      VAUXN(11) => vauxn11,
      VAUXN(10 downto 0) => B"00000000000",
      VAUXP(15 downto 12) => B"0000",
      VAUXP(11) => vauxp11,
      VAUXP(10 downto 0) => B"00000000000",
      VN => vn_in,
      VP => vp_in
    );
end STRUCTURE;
